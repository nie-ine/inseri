 ...
 */
@Component({
  selector: 'app-joined-text-innerhtml',
  templateUrl: './joined-text-innerhtml.component.html',
  styleUrls: ['./joined-text-innerhtml.component.scss']
})
export class JoinedTextInnerhtmlComponent implements OnInit, OnChanges, AfterViewInit {
