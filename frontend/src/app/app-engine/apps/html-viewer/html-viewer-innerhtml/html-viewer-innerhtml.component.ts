 ...
 */
@Component({
  selector: 'app-html-viewer-innerhtml',
  templateUrl: './html-viewer-innerhtml.component.html',
  styleUrls: ['./html-viewer-innerhtml.component.scss']
})
export class HtmlViewerInnerhtmlComponent implements OnInit, OnChanges, AfterViewInit {
