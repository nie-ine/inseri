...
Inseri is conceived at present as to create a set of pages that can be published as a single webpage with an automatically set up navigation in between. The user creates each page separately, as an independent "collage".
